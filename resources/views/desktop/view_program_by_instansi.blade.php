...
<head>
    ...
    <link rel="stylesheet" href="{{ statics('assets/css/desktop_slick.css?v=0.0.1') }}">
                            ...
                            <div class="single-mentor-first-wrap">
                                <div class="mentor-img-sec">
                                    <img style="width: 150px; height: 150px; object-fit: contain;"
                                        src="{{ uploads('storage/instance_logo/' . $item->logo) }}" alt="client-img">
                                </div>
                                                                    ...
                                                                    <div class="result-content-sec-wrap mt-1">
                                                                        <div class="content-first">
                                                                            <div class="result-bottom-txt">
                                                                                <p>{{ isset($item->program_categories_name) ? $item->program_categories_name : '-' }}
                                                                                </p>
                                                                            </div>
                                                                        </div>
