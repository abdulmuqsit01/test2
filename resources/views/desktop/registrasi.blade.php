...
<head>
    ...
    <link rel="stylesheet" href="{{ statics('assets/css/slick.css') }}" />
    <link rel="stylesheet" href="{{ statics('assets/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ statics('assets/css/intlTelInput.css') }}" />
    <link rel="stylesheet" href="{{ statics('assets/css/style.css') }}" />
    <link rel="stylesheet" href="{{ statics('assets/css/media-query.css') }}" />
</head>
...
<body>
        ...
        <section id="sign-up-screen-content">
            <div class="container">
                ...
                <div class="sign-up-login-form mt-24">
                    <form method="POST" action="{{ route('mutate_register') }}">
                        @csrf
                        ...
                        <div class="form-details-sign-in mt-12">
                            <img src="{{ statics('desktop/home2.svg') }}" alt="right-arrow" height="24"
                                width="24" />
                        ...
                        <div class="form-details-sign-in mt-12">
                            <img src="{{ statics('desktop/phone.svg') }}" alt="right-arrow" height="24"
                                width="24" />
                            <input type="text" id="nomorhp" name="no_hp" placeholder="Nomor Handphone"
                                class="sign-in-custom-input" />
                        </div>
                        <div class="form-details-sign-in mt-12">
                        ...
                        <br>
                        {{-- VALUE STATIC --}}
                        <input type="hidden" value="72074607" name="program_id">
                        <button class="button_singup" type="submit">
                            Simpan
                        </button>
                    </form>
                </div>
        ...
        <footer id="let-you-footer">
            {{-- <div class="block-footer">
                    <p>
                        ...
                        <a href="sign-in-screen.html">Sign In</a>
                    </p>
                </div> --}}
        </footer>
        <!-- Footer end -->
    ...
    <script src="{{ statics('assets/js/intlTelInput-jquery.min.js') }}"></script>
    <script src="{{ statics('assets/js/country-flag.js') }}"></script>
