    ...
    <div class="site-content">
        ...
        <div class="profile-screen">
            <div class="container profile">
                <div class="profile-screen-wrap mt-16">
                    <div class="profile-first">
                        <div class="profile-edit-img">
                            <img src="{{ data_get(
                                ...
                                'photo',
                                "
                                                                                    									https://cdn.digitaldesa.com/uploads/marketplace/users/thumbs/no_image.jpg",
                            ) }}"
                                alt="profile-img" height="105" width="105"
                                style="background-color: azure; object-fit: cover">
                        </div>
                        <div class="profile-details mt-16">
                            <h1>{{ data_get($user, 'fullname', 'Belum Login') }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="result-content-sec-wrap mt-1">
                                        <div class="content-first">
                                            <div class="result-bottom-txt">
                                                <p>{{ data_get($item->program, 'programCategories.name', '-') }}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="content-fourth mt-1">
                                            <div class="result-rating-sec">
                                                <div class="result-rating-txt">
                                                    <span class="program-tag">{{ $item->program->tag }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="home-navigation-menu">
                <div class="bottom-panel nagivation-menu-wrap">
                    <ul class="bootom-tabbar">
                        <li>
                            <a href="{{ route('view_mobile_home') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <mask id="mask0_202_7251" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0"
                        ...
                        <li class="active">
                            <a href="{{ route('view_mobile_profile') }}" class="active">
